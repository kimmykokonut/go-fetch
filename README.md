...
5. In this new directory, via the terminal, type `$ git clone https://github.com/kimmykokonut/go-fetch.git`.
6. View or Edit: On your terminal, navigate to the root directory, type `$ code .` to open the project in VS Code.
